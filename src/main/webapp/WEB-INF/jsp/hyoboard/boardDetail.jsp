                            ...
                            <table class="detailArea" style="width: 100%;  border-collapse: separate; border-spacing: 10px 20px;">
                                ...
                                <tr class="noticeTextBox">
                                    <td class="TextArea"  colspan="4" style="height:500px; text-align:-webkit-auto;"> 
                                        <textarea name="content" style="width:100%; height:100%; padding:1%; resize:none"></textarea>
                                    </td>
                                ...
                                <tr class="buttonArea" style="text-align: center;">
                                    <td class="buttonArea"  colspan="4">												
                                        ...
                                        <button class="site-btn" type="button" onclick="location.href='insert'" style="background-color: white; padding-left:15px; padding-right: 15px; min-width:120px; padding-top:10px; padding-bottom: 10px; border: solid 1px rgb(161, 161, 161);">
                                        	    삭제하기
                                        </button>
                                    </td>
                                </tr>
