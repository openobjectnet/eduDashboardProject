                            ...
                            <table class="detailArea" style="width: 100%;  border-collapse: separate; border-spacing: 10px 20px;">
                                <tr class="TitleArea" >
                                    ...
                                    <td class="Title2" colspan="3" >
                                        <input type="text" placeholder="제목을 입력해주세요" name="nTitle" style="width: 100%;" >
                                    </td>
                                    
                                </tr>
                                <tr class="UserNameArea">
                                    <td class="UserName1" style="color: black;">작성자</td>
                                    <td class="UserName2" >유저아이디</td>
                                    <td class="" style="color: black;">작성일</td>
                                    <td class="" >2020/10/20</td>
                                </tr>
                                <tr class="noticeTextBox">
                                    <td class="noticeTextArea"  colspan="4" style="height:500px; text-align:-webkit-auto;"> 
                                        <textarea name="nContent" style="width:100%; height:100%; padding:1%; resize:none"></textarea>
                                    </td>
                                ...
                                <tr class="buttonArea" style="text-align: center;">
                                    <td class="buttonArea"  colspan="4">												
                                        ...
                                        <button class="site-btn" type="button" onclick="location.href='ad_noticeList.do'" style="background-color: white; padding-left:15px; padding-right: 15px; min-width:120px; padding-top:10px; padding-bottom: 10px; border: solid 1px rgb(161, 161, 161);">
                                        	    목록가기
                                        </button>
                                    </td>
                                </tr>
